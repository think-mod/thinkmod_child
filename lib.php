...
function theme_thinkmod_child_update_settings_images($settingname) {
    ...
    //$pathname = $CFG->wwwroot . '/theme/thinkmod_child/pix/' . $settingname . '.' . $extension;

    // This pattern matches any previous files with maybe different file extensions.
    $pathpattern = $CFG->dataroot . '/pix_plugins/theme/thinkmod_child/' . $settingname . '.*';
    //$pathpattern = $CFG->wwwroot . '/theme/thinkmod_child/pix/' . $settingname . '.*';

    // Make sure this dir exists.
    @mkdir($CFG->dataroot . '/pix_plugins/theme/thinkmod_child/', $CFG->directorypermissions, true);

    //@mkdir($CFG->wwwroot . '/theme/thinkmod_child/pix', $CFG->directorypermissions, true);
 ...
 */
function thinkmod_child_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    if (!has_capability('theme/thinkmod_child:view', $context)) {
        return false;
    }
    ...
    $fs = get_file_storage();
    $file = $fs->get_file($context->id, 'theme_thinkmod_child', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
