...
namespace theme_thinkmod_child\output;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_thinkmod_child_core_renderer extends \theme_moove\output\core_renderer {
    /**
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_thinkmod_child/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/thinkmod_child/pix";
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            ...
            return $this->render_from_template('theme_thinkmod_child/frontpage_guest_loginbtn', $context);
        }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_thinkmod_child/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'thinkmod_child-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function breadcrumb_header() {
        ...
        if ($this->page->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_thinkmod_child') ."</h2>";
        }

        return $this->render_from_template('theme_thinkmod_child/breadcrumb', $header);
    }
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themethinkmod_childsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themethinkmod_childsettings_fonttype', '');
        if ($fonttype) {
