...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingthinkmod_child', get_string('configtitle', 'theme_thinkmod_child'));
    ...
    */
    ...
    $description = 'My logo here';/*get_string('logodesc', 'theme_moove');*/
    ...
    // Favicon setting.
    $name = 'theme_thinkmod_child/favicon';
    ...
    // Preset.
    $name = 'theme_thinkmod_child/preset';
    ...
    $name = 'theme_thinkmod_child/presetfiles';
    ...
    $name = 'theme_thinkmod_child/loginbgimg';
    ...
    $name = 'theme_thinkmod_child/brandcolor';
    ...
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_thinkmod_child/navbarheadercolor';
    ...
    // Variable $navbar-bg.
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_thinkmod_child/navbarbg';
    ...
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_thinkmod_child/navbarbghover';
    ...
    $name = 'theme_thinkmod_child/coursepresentation';
    ...
    $name = 'theme_thinkmod_child/courselistview';
    ...
    /*
    * ----------------------
    * Course Sub-Theme settings tab
    * ----------------------
    */
    $page = new admin_settingpage('theme_thinkmod_child_subtheme', get_string('coursethemesettingstitle', 'theme_thinkmod_child'));
    ...
    foreach(array_slice($courses, 1) as $course) { // first course will be the general site
        ...
        $name = 'theme_thinkmod_child/courseColor'.$course->id;
        ...
        $name = 'theme_thinkmod_child/coursecustomsvg'.$course->id;
        $title = get_string('coursecustomsvg', 'theme_thinkmod_child').' '.$course->id;
        $description = get_string('coursecustomsvgdesc', 'theme_thinkmod_child');
        // This creates the new setting.
        $settingname = 'coursecustomsvg'.$course->id;
        $setting = new admin_setting_configstoredfile($name, $title, $description, $settingname);
    ...
    */
    ...
    $setting = new admin_setting_scsscode('theme_thinkmod_child/scsspre',
        get_string('rawscsspre', 'theme_moove'), get_string('rawscsspre_desc', 'theme_moove'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Raw SCSS to include after the content.
    $setting = new admin_setting_scsscode('theme_thinkmod_child/scss', get_string('rawscss', 'theme_moove'),
        get_string('rawscss_desc', 'theme_moove'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Google analytics block.
    $name = 'theme_thinkmod_child/googleanalytics';
    ...
    */
    ...
    $name = 'theme_thinkmod_child/disablefrontpageloginbox';
    ...
    $name = 'theme_thinkmod_child/disableteacherspic';
    ...
    $name = 'theme_thinkmod_child/headerimg';
    ...
    // Bannerheading.
    $name = 'theme_thinkmod_child/bannerheading';
    ...
    // Bannercontent.
    $name = 'theme_thinkmod_child/bannercontent';
    ...
    $name = 'theme_thinkmod_child/displaymarketingbox';
    ...
    // Marketing1icon.
    $name = 'theme_thinkmod_child/marketing1icon';
    ...
    // Marketing1heading.
    $name = 'theme_thinkmod_child/marketing1heading';
    ...
    $name = 'theme_thinkmod_child/marketing1subheading';
    ...
    // Marketing1content.
    $name = 'theme_thinkmod_child/marketing1content';
    ...
    // Marketing1url.
    $name = 'theme_thinkmod_child/marketing1url';
    ...
    // Marketing2icon.
    $name = 'theme_thinkmod_child/marketing2icon';
    ...
    // Marketing2heading.
    $name = 'theme_thinkmod_child/marketing2heading';
    ...
    $name = 'theme_thinkmod_child/marketing2subheading';
    ...
    // Marketing2content.
    $name = 'theme_thinkmod_child/marketing2content';
    ...
    // Marketing2url.
    $name = 'theme_thinkmod_child/marketing2url';
    ...
    // Marketing3icon.
    $name = 'theme_thinkmod_child/marketing3icon';
    ...
    // Marketing3heading.
    $name = 'theme_thinkmod_child/marketing3heading';
    ...
    $name = 'theme_thinkmod_child/marketing3subheading';
    ...
    // Marketing3content.
    $name = 'theme_thinkmod_child/marketing3content';
    ...
    // Marketing3url.
    $name = 'theme_thinkmod_child/marketing3url';
    ...
    // Marketing4icon.
    $name = 'theme_thinkmod_child/marketing4icon';
    ...
    // Marketing4heading.
    $name = 'theme_thinkmod_child/marketing4heading';
    ...
    $name = 'theme_thinkmod_child/marketing4subheading';
    ...
    // Marketing4content.
    $name = 'theme_thinkmod_child/marketing4content';
    ...
    // Marketing4url.
    $name = 'theme_thinkmod_child/marketing4url';
    ...
    $name = 'theme_thinkmod_child/sliderenabled';
    ...
    $name = 'theme_thinkmod_child/sliderfrontpage';
    ...
    $name = 'theme_thinkmod_child/slidercount';
    ...
    for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
        ...
        $name = 'theme_thinkmod_child/sliderimage' . $sliderindex;
    ...
    // Enable or disable Slideshow settings.
    $name = 'theme_thinkmod_child/numbersfrontpage';
    ...
    $name = 'theme_thinkmod_child/sponsorsfrontpage';
    ...
    $name = 'theme_thinkmod_child/sponsorstitle';
    ...
    $name = 'theme_thinkmod_child/sponsorssubtitle';
    ...
    $name = 'theme_thinkmod_child/sponsorscount';
    ...
    for ($sponsorsindex = 1; $sponsorsindex <= $sponsorscount; $sponsorsindex++) {
        ...
        $name = 'theme_thinkmod_child/sponsorsimage' . $sponsorsindex;
        ...
        $name = 'theme_thinkmod_child/sponsorsurl' . $sponsorsindex;
    ...
    $name = 'theme_thinkmod_child/clientsfrontpage';
    ...
    $name = 'theme_thinkmod_child/clientstitle';
    ...
    $name = 'theme_thinkmod_child/clientssubtitle';
    ...
    $name = 'theme_thinkmod_child/clientscount';
    ...
    for ($clientsindex = 1; $clientsindex <= $clientscount; $clientsindex++) {
        ...
        $name = 'theme_thinkmod_child/clientsimage' . $clientsindex;
        ...
        $name = 'theme_thinkmod_child/clientsurl' . $clientsindex;
    ...
    */
    ...
    $name = 'theme_thinkmod_child/getintouchcontent';
    ...
    // Website.
    $name = 'theme_thinkmod_child/website';
    ...
    // Mobile.
    $name = 'theme_thinkmod_child/mobile';
    ...
    // Mail.
    $name = 'theme_thinkmod_child/mail';
    ...
    $name = 'theme_thinkmod_child/facebook';
    ...
    // Twitter url setting.
    $name = 'theme_thinkmod_child/twitter';
    ...
    // Linkdin url setting.
    $name = 'theme_thinkmod_child/linkedin';
    ...
    // Youtube url setting.
    $name = 'theme_thinkmod_child/youtube';
    ...
    $name = 'theme_thinkmod_child/instagram';
    ...
    $name = 'theme_thinkmod_child/whatsapp';
    ...
    $name = 'theme_thinkmod_child/topfooterimg';
    ...
    // Disable bottom footer.
    $name = 'theme_thinkmod_child/disablebottomfooter';
    $title = 'disable bottom footer';//get_string('disablebottomfooter', 'theme_moove');
    $description = 'disable bottom footer';//get_string('disablebottomfooterdesc', 'theme_moove');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $page->add($setting);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_thinkmod_child/forumcustomtemplate';
    ...
    // Header setting.
    $name = 'theme_thinkmod_child/forumhtmlemailheader';
    ...
    // Footer setting.
    $name = 'theme_thinkmod_child/forumhtmlemailfooter';
